...
const nav = props => (
          <Container show={props.show}>
                    ...
                    <LinksMenu>                              
                              ...
                              <h2><a href='https://github.com/gustavoleste/react-dev-jobs' target='_blank' rel='external noopener noreferrer'>GitHub <FontAwesomeIcon icon={faExternalLinkAlt} size='xs'/></a></h2>                              
                    </LinksMenu>
          </Container>
)
